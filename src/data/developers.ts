...
export const developers: Developer[] = [
  ...
  },
  {
    ...
    whyITrustThem: {
      fr: "",
      en: "DRAFT — pending Tommy's review. Ellington Properties is a design-led Dubai developer founded in 2014 by Elie Naaman, Robert D. Booth, Joseph Thomas and Nitin Bhatnagar — Booth previously served as Managing Director at Emaar Properties. Its portfolio includes DT1 in Downtown Dubai, Ocean House on Palm Jumeirah and Ellington House in Dubai Hills Estate. The company has received multiple International Property Awards, including wins across all seven categories it entered in 2024, and was named Best Luxury Real Estate Developer in Dubai at the 2025 Luxury Lifestyle Awards.",
    },
    overview: {
      fr: "",
